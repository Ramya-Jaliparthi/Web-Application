...
@Component({
  templateUrl: './campaign-6.component.html',
  styleUrls: ['./campaign-6.component.scss']
})

export class Campaign6Component implements OnInit, OnDestroy {
  ...
  constructor(private globalService: GlobalService,
            ...
            private authHttp: AuthHttp) {
              ...
              this.fpoTargetUrl = this.constants.drupalContentCampaignUrl6;
  }
  ngOnInit() {
