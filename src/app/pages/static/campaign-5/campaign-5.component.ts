...
@Component({
  templateUrl: './campaign-5.component.html',
  styleUrls: ['./campaign-5.component.scss']
})

export class Campaign5Component implements OnInit, OnDestroy {
  ...
  constructor(private globalService: GlobalService,
            ...
            private authHttp: AuthHttp) {
              ...
              this.fpoTargetUrl = this.constants.drupalContentCampaignUrl5;
  }
  ngOnInit() {
