...
@Component({
  templateUrl: './campaign-4.component.html',
  styleUrls: ['./campaign-4.component.scss']
})

export class Campaign4Component implements OnInit, OnDestroy {
  ...
  constructor(private globalService: GlobalService,
            ...
            private authHttp: AuthHttp) {
              ...
              this.fpoTargetUrl = this.constants.drupalContentCampaignUrl4;
  }
  ngOnInit() {
