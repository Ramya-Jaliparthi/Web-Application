...
@Component({
  templateUrl: './campaign-1.component.html',
  styleUrls: ['./campaign-1.component.scss']
})

export class Campaign1Component implements OnInit, OnDestroy {
  ...
  constructor(private globalService: GlobalService,
            ...
            private authHttp: AuthHttp) {
              ...
              this.fpoTargetUrl = this.constants.drupalContentCampaignUrl1;
  }
  ngOnInit() {
