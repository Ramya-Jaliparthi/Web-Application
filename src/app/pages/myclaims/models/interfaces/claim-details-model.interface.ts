...
export interface ClaimDetailsRequestModelInterface extends MyBlueGeneralAPIRequestModelInterface {
    claimId: string; // example: 1234567890000
    recordKey: string; // example: 123123
}

export interface ClaimDetailsResponseModelInterface {
    claimDetails: ClaimDetailInterface;
...
export interface ClaimDetailInterface {
    ...
    providerAddress: ClaimAddressModelInterface;
    ...
    claimTotals: ClaimTotalInterface;
    claimServiceLines: ClaimServiceLineInterface[];
...
export interface ClaimAddressModelInterface {
...
export interface ClaimTotalInterface {
...
export interface ClaimServiceLineInterface {
    amountCharged: number; // example: 100
    amountAllowed: number; // example: 100
    amountCoveredByBCBS: number; // example: 100
    amountCoveredByOthers: number; // example: 100
