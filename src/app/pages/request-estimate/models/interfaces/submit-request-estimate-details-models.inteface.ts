...
export interface SubmitRequestEstimateDetailsRequestModelInterface extends MyBlueGeneralAPIRequestModelInterface {
    ...
    submitterZip: string; // example: Submitter Zip Code
...
export interface SubmitRequestEstimateDetailsResponseModelInterface extends GeneralErrorInterface {
